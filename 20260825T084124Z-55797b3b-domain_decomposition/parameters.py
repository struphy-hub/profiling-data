...
def main() -> None:
    ...
    parser.add_argument("--radial-elements", type=int, default=NUM_ELEMENTS[0])
    parser.add_argument("--warmups", type=int, default=1)
    parser.add_argument("--repetitions", type=int, default=2)
    parser.add_argument("--output", default=None)
    args, _ = parser.parse_known_args()

    num_elements = (args.radial_elements, NUM_ELEMENTS[1], NUM_ELEMENTS[2])
    output = args.output or f"sim_{args.id:02d}"
